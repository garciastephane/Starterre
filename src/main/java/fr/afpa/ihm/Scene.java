...
public class Scene extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		if (crash()) {
			g2.drawImage(this.avion.getExplosionVaisseau(), this.avion.getX(), this.avion.getY(),
					this.avion.getLargeur(), this.avion.getHauteur(), this);

		} else {
			g2.drawImage(this.avion.getImgVaisseau(), this.avion.getX(), this.avion.getY(), this.avion.getLargeur(),
					this.avion.getHauteur(), this);
		}

		g2.drawImage(this.meteorite.getMeteorite(), this.meteorite.getX(), this.meteorite.getY(),
				this.meteorite.getLargeur(), this.meteorite.getHauteur(), this);
		g2.drawImage(this.meteoriteFeu.getMeteorite(), this.meteoriteFeu.getX(), this.meteoriteFeu.getY(),
				this.meteoriteFeu.getLargeur(), this.meteoriteFeu.getHauteur(), this);
		g2.drawImage(this.meteoriteGlace.getMeteorite(), this.meteoriteGlace.getX(), this.meteoriteGlace.getY(),
				this.meteoriteGlace.getLargeur(), this.meteoriteGlace.getHauteur(), this);
